...
//     // Allocate the 64MB pool on the Heap to prevent Stack Overflow
//     auto pool_ptr = std::make_unique<LockFreeMemoryPool<MarketUpdate, 1'000'000>>();
//     auto& pool = *pool_ptr; 
...
//     auto stress_task = [&pool](int iters) {
